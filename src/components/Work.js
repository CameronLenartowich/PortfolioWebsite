    ...
    <div className={classes.root}>
      ...
      >
        ...
        <Paper className={classes.paper}>
          ...
          <Typography variant="body1" gutterBottom className={classes.bodyText}>
            Obtained certification from chainshot for completing the Ethereum
            Dev Bootcamp. The course was a intensive course that taught the
            fundamentals of blockchain technology. The course was taught by a
            team of blockchain engineers and developers. The course covered
            topics such as smart contract development with solidity and building
        ...
        <Paper className={classes.paper}>
          ...
          <Typography variant="body1" gutterBottom className={classes.bodyText}>
            Thinkful is a highly rated coding school in North America. Graduated
            from Thinkful in 2019 as a software engineer. The following projects
            were built during the time there:
          </Typography>
            ...
            {work.thinkful.map((value, index) => (
              <Grid item sm={6} xs={12} key={index}>
                <Paper className={classes.paper}>
                  ...
                  <div className={classes.workDescriptionContainer}>
                    <Typography
                      variant="body1"
                      gutterBottom
                    ...
                    <div className={classes.buttonContainer}>
                      {value.name != "Wikipedia" &&
                        value.name != "Destination Tracker" && (
                          <a
                            href={value.link}
                            target="_blank"
                            className={classes.link}
        ...
        <Paper className={classes.paper}>
          ...
          <Typography variant="body1" gutterBottom className={classes.bodyText}>
            As a freelancer, helped Brookfield Septic with building their online
            presence. This involved building both their website and social media
            profile.
          </Typography>
          <Grid container spacing={3}>
